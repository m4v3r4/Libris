...
class DatabaseProvider extends ChangeNotifier {
  ...
  /// Veritabanında bir değişiklik olduğunda dinleyen widget'ları yeniler.
  ///
  ...
  Future<List<Map<String, dynamic>>> getCategoriesWithStats() async {
    return _dbHelper.getCategoriesWithStats();
  }
  ...
  Future<List<Map<String, dynamic>>> getActiveLoans() async {
    return _dbHelper.getActiveLoans();
  }

  Future<List<Loan>> getLoans() async {
    return _dbHelper.getLoans();
  }
  ...
  Future<List<Map<String, dynamic>>> getOverdueLoans() async {
    return _dbHelper.getOverdueLoans();
  }
}
